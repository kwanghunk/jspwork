...
<form name="frm" method ="post" action="memberProc.jsp">
    <table border="1">
        ...
        <tr>
            <td>아이디</td>
            <td>
                <input name="id" onkeydown="inputIdChk();">&emsp;
                <input type="button" value="ID중복확인" onclick="idCheck(this.form.id.value);"><!-- 중복확인 -->
                <input type="hidden" name="idBtnCheck" value="idUncheck"><!-- 중복확인 후 수정 방지용 -->
            </td>
            <td>영문과 숫자로만 입력</td>
        </tr>
        <tr>
